                            ...
                            <div className="flex items-center gap-1.5 shrink-0" onClick={(e) => e.stopPropagation()}>
                              ...
                              {isAdmin && (
                                <button
                                  ...
                                  className="p-1.5 bg-slate-50 dark:bg-slate-800 hover:bg-amber-50 text-slate-500 hover:text-amber-600 dark:hover:text-amber-400 rounded-lg transition-all border border-slate-200 dark:border-slate-700 cursor-pointer"
                                  title="Edit PDF Note"
                                >
                              ...
                              {isAdmin && (
                                <button
                                  type="button"
                                  onClick={() => setDeleteModalNoteId(note.id)}
                                  className="p-1.5 bg-slate-50 dark:bg-slate-800 hover:bg-rose-50 text-slate-500 hover:text-rose-600 dark:hover:text-rose-400 rounded-lg transition-all border border-slate-200 dark:border-slate-700 cursor-pointer"
                                  title="Delete PDF"
                                >
